...
const locales = {
  nl: {
    ...
    legendPandStatusTitle: "Pand status",
    pandStatusBucketInUse: "In gebruik",
    pandStatusBucketInProgress: "In aanbouw / vergund",
    pandStatusBucketGone: "Gesloopt / niet gebouwd",
    pandStatusShowingOfTotal: "Toont {shown} van {total} panden",
    pandStatusShowingAll: "Toont alle {total} panden",
    pandStatusShowingNone: "Geen panden zichtbaar",
    pandStatusPandInGebruik: "Pand in gebruik",
    pandStatusPandInGebruikNietIngemeten: "Pand in gebruik (niet ingemeten)",
    pandStatusVerbouwingPand: "Verbouwing pand",
    pandStatusPandBuitenGebruik: "Pand buiten gebruik",
    pandStatusBouwvergunningVerleend: "Bouwvergunning verleend",
    pandStatusBouwGestart: "Bouw gestart",
    pandStatusPandInAanbouw: "Pand in aanbouw",
    pandStatusSloopvergunningVerleend: "Sloopvergunning verleend",
    pandStatusPandGesloopt: "Pand gesloopt",
    pandStatusNietGerealiseerdPand: "Niet gerealiseerd pand",
    pandStatusPandTenOnrechteOpgevoerd: "Pand ten onrechte opgevoerd",
    legendBagStatusTitle: "BAG status",
    legendStandplaatsStatusTitle: "Standplaats status",
    legendLigplaatsStatusTitle: "Ligplaats status",
    bagStatusSectionPand: "Panden",
    bagStatusSectionStandplaats: "Standplaatsen",
    bagStatusSectionLigplaats: "Ligplaatsen",
    plaatsStatusBucketLive: "Aangewezen / uitgegeven",
    plaatsStatusBucketGone: "Ingetrokken / niet gebouwd",
    plaatsStatusShowingOfTotal: "Toont {shown} van {total} plaatsen",
    plaatsStatusShowingAll: "Toont alle {total} plaatsen",
    plaatsStatusShowingNone: "Geen plaatsen zichtbaar",
    plaatsStatusPlaatsAangewezen: "Plaats aangewezen",
    plaatsStatusPlaatsUitgegeven: "Plaats uitgegeven",
    plaatsStatusNietGerealiseerdePlaats: "Niet gerealiseerde plaats",
    plaatsStatusPlaatsIngetrokken: "Plaats ingetrokken",
    plaatsStatusPlaatsTenOnrechteOpgevoerd: "Plaats ten onrechte opgevoerd",
  ...
  en: {
    ...
    legendPandStatusTitle: "Building status",
    pandStatusBucketInUse: "In use",
    pandStatusBucketInProgress: "Under construction / permitted",
    pandStatusBucketGone: "Demolished / never built",
    pandStatusShowingOfTotal: "Showing {shown} of {total} buildings",
    pandStatusShowingAll: "Showing all {total} buildings",
    pandStatusShowingNone: "No buildings visible",
    pandStatusPandInGebruik: "In use",
    pandStatusPandInGebruikNietIngemeten: "In use (not surveyed)",
    pandStatusVerbouwingPand: "Under renovation",
    pandStatusPandBuitenGebruik: "Out of use",
    pandStatusBouwvergunningVerleend: "Building permit granted",
    pandStatusBouwGestart: "Construction started",
    pandStatusPandInAanbouw: "Under construction",
    pandStatusSloopvergunningVerleend: "Demolition permit granted",
    pandStatusPandGesloopt: "Demolished",
    pandStatusNietGerealiseerdPand: "Never built",
    pandStatusPandTenOnrechteOpgevoerd: "Registered in error",
    legendBagStatusTitle: "BAG status",
    legendStandplaatsStatusTitle: "Standplace status",
    legendLigplaatsStatusTitle: "Mooring place status",
    bagStatusSectionPand: "Buildings",
    bagStatusSectionStandplaats: "Standplaces",
    bagStatusSectionLigplaats: "Mooring places",
    plaatsStatusBucketLive: "Designated / issued",
    plaatsStatusBucketGone: "Withdrawn / never built",
    plaatsStatusShowingOfTotal: "Showing {shown} of {total} places",
    plaatsStatusShowingAll: "Showing all {total} places",
    plaatsStatusShowingNone: "No places visible",
    plaatsStatusPlaatsAangewezen: "Designated",
    plaatsStatusPlaatsUitgegeven: "Issued",
    plaatsStatusNietGerealiseerdePlaats: "Never realized",
    plaatsStatusPlaatsIngetrokken: "Withdrawn",
    plaatsStatusPlaatsTenOnrechteOpgevoerd: "Registered in error",
...
// Map from canonical BAG status string → translation key. Use with tr().
export const PAND_STATUS_TR_KEYS = {
  'Pand in gebruik':                    'pandStatusPandInGebruik',
  'Pand in gebruik (niet ingemeten)':   'pandStatusPandInGebruikNietIngemeten',
  'Verbouwing pand':                    'pandStatusVerbouwingPand',
  'Pand buiten gebruik':                'pandStatusPandBuitenGebruik',
  'Bouwvergunning verleend':            'pandStatusBouwvergunningVerleend',
  'Bouw gestart':                       'pandStatusBouwGestart',
  'Pand in aanbouw':                    'pandStatusPandInAanbouw',
  'Sloopvergunning verleend':           'pandStatusSloopvergunningVerleend',
  'Pand gesloopt':                      'pandStatusPandGesloopt',
  'Niet gerealiseerd pand':             'pandStatusNietGerealiseerdPand',
  'Pand ten onrechte opgevoerd':        'pandStatusPandTenOnrechteOpgevoerd',
};

// Standplaats and ligplaats share the same status vocabulary. Keep one
// lookup that both reuse.
export const PLAATS_STATUS_TR_KEYS = {
  'Plaats aangewezen':              'plaatsStatusPlaatsAangewezen',
  'Plaats uitgegeven':              'plaatsStatusPlaatsUitgegeven',
  'Niet gerealiseerde plaats':      'plaatsStatusNietGerealiseerdePlaats',
  'Plaats ingetrokken':             'plaatsStatusPlaatsIngetrokken',
  'Plaats ten onrechte opgevoerd':  'plaatsStatusPlaatsTenOnrechteOpgevoerd',
};
